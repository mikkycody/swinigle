...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2019 at 08:37 PM
...
(227, 'last_notification_delete_run', '1567535128'),
...
(1564, 'no_funding_found', 'No funding found', 'No funding found', 'لم يتم العثور على تمويل', 'Geen financiering gevonden', 'Aucun financement trouvé', 'Keine Finanzierung gefunden', 'Nessun finanziamento trovato', 'Nenhum financiamento encontrado', 'Финансирование не найдено', 'No se encontraron fondos.', 'Fon bulunamadı'),
...
INSERT INTO `Wo_Manage_Pro` (`id`, `type`, `price`, `featured_member`, `profile_visitors`, `last_seen`, `verified_badge`, `posts_promotion`, `pages_promotion`, `discount`, `image`, `status`, `time`) VALUES
